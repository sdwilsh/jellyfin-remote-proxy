...
## [0.1.10](https://github.com/sdwilsh/jellyfin-remote-proxy/compare/v0.1.9...v0.1.10) - 2026-05-28

### Fixed

- *(deps)* update rust-deps ([#108](https://github.com/sdwilsh/jellyfin-remote-proxy/pull/108))

### Other

- *(deps)* lock file maintenance ([#114](https://github.com/sdwilsh/jellyfin-remote-proxy/pull/114))
- *(deps)* update rust
...
- include curl in image for health checks

### Other

- *(deps)* update debian:bookworm-slim docker digest to 1371f81
